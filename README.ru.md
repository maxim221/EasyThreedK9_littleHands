...
- после неудачного старта печати самый надёжный способ восстановления — power cycle принтера
- Windows-дистрибутив пока только запланирован
- сам UI приложения пока в основном русский, хотя документация уже двуязычная
