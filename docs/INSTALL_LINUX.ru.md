...
## 8. Cura Baseline Для Проверенного Второго K9
...
Не используй старую подрезанную машину от первого экспериментального принтера, если только не хочешь специально воспроизвести старый setup.
...
Если старт печати сорвался, принтер только щёлкает или телеметрия замёрзла, сейчас самый надёжный workflow такой:
