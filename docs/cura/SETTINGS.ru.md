...
- если файл загружается через Little Hands или slicing helper, ранний `M109` внутри SD-файла будет заменён на `M104`; Little Hands сам выполнит блокирующий предпрогрев hotend через host-side `M109` перед SD-стартом
